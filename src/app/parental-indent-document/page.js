...
export default function ParentalIndentDocument() {
  ...
  useEffect(() => {
    ...
    if (userInfo?.document_parent_identity_document_front) {
      setSelectedFileFront(userInfo?.document_parent_identity_document_front);
    }

    if (userInfo?.document_parent_identity_document_back) {
      setSelectedFileBack(userInfo?.document_parent_identity_document_back);
    }
  ...
  const handleSubmit = () => {
    ...
    if (selectedFileFront) {
      user.document_parent_identity_document_front = selectedFileFront;
    }

    if (selectedFileBack) {
      user.document_parent_identity_document_back = selectedFileBack;
    }
